...
| **[PropertyHub](https://github.com/NjabuloNyawuza/PropertyHub)** | Full-stack real estate platform with property listings, agent profiles, an admin dashboard, and image uploads | HTML, CSS, JavaScript, PHP, MySQL |
...
| **[BillSplitter](https://github.com/NjabuloNyawuza/BillSplitter)** | Web app for splitting bills and calculating tips across groups, with multi-currency support and calculation history | HTML, CSS, JavaScript, Local Storage |
